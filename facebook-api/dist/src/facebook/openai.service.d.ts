...
import { AnalysisResults, CreativeAnalysis, CreativeAnalysisResult, ImagePromptResponse, LandingPageAnalysis, LandingPageAnalysisResult, TextAnalysis, TextAnalysisError } from 'src/facebook/models/interfaceGpt';
export declare class OpenAIService {
    ...
    sendTextPrompt(promptData: GPTads, brandName: string): Promise<TextAnalysis | TextAnalysisError>;
